...
namespace ProjectEuler.Toolbox
{
    ...
    {
        public static int CompressThreshold { get { return 1000000; } }
        private readonly Queue<long> readQueue = new Queue<long>();
        private readonly Queue<long> writeQueue = new Queue<long>();
